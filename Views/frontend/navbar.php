        ...
        <div class="collapse navbar-collapse justify-content-end" id="responsiveNavbar">
            <ul class="navbar-nav pt-3 pt-lg-0">
                <li class="nav-item ms-4">
                    <a class="nav-link active clearBrownCol p-1" aria-current="page" href="index.php"><i
                            class="fas fa-home"></i></a>
                </li>
                <li class="nav-item ms-4">
                    <a class="nav-link darkBrownCol p-1" href="/laGuilde.php">La guilde</a>
                </li>
                <li class="nav-item ms-4">
                    <a class="nav-link darkBrownCol p-1" href="/discoverAppli.php">Découvrez
                        l'application</a>
                </li>
                <li class="nav-item ms-4">
                    <a class="nav-link darkBrownCol p-1" href="/index.php#contactSection">Contact</a>
                </li>
                <li class="connectionResponsive nav-item ms-4">
                    <a class="nav-link darkBrownCol p-1" href="/connection.php">Se connecter</a>
                </li>
                <li class="inscriptionResponsive nav-item ms-4">
                    <a class="nav-link darkBrownCol p-1" href="/inscription.php">S'inscrire</a>
                </li>
            </ul>
        </div>
    </div>
